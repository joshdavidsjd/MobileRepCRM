...
import { X, Building, Globe, Phone, MapPin, Users, DollarSign, FileText, Tag } from 'lucide-react-native';
...
export default function AccountForm({ account, onClose, onSave }: AccountFormProps) {
  ...
  const validateForm = () => {
    ...
    if (formData.employees && isNaN(parseInt(formData.employees))) {
        ...
        <View style={styles.section}>
          ...
          <View style={styles.inputGroup}>
            <View style={styles.inputWrapper}>
              ...
              <TextInput
                style={[styles.input, errors.employees && styles.inputError]}
            ...
            <View style={styles.inputWrapper}>
              ...
              <TextInput
                style={styles.input}
                placeholder="Annual revenue (e.g., $50M)"
                placeholderTextColor="#94a3b8"
                value={formData.revenue}
                onChangeText={(value) => updateFormData('revenue', value)}
              />
            </View>
